...
<body>
                                ...
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody class="crm-table-content">
                                        <tr itemscope itemtype="http://schema.org/Person">
                                            ...
                                            <td class="text-center"><a href="modifica-contatto.php"><button type="button" class="btn crm-button">Modifica</button></a></td>
                                        </tr>
                                        <tr itemscope itemtype="http://schema.org/Person">
                                            <td class="text-center campaign">Kimbo</td>
                                            <td itemprop="givenName" class="text-center"><?= $faker->firstName ?></td>
    ...
    <script>
        $(".crm-button").click(function() {
            window.location.href = "visualizza-storico-admin.php";
        });
