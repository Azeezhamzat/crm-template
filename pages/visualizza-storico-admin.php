...
<body>
            ...
            <div class="col-md-6">
                <form>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="contactID" placeholder="ID" value="<?= rand(1, 1000); ?>" disabled>
                    </div>
                    <div class="form-group">
    ...
    <div class="row">
        <div class="col-lg-offset-5">
            <button type="button" class="btn btn-primary back-btn">Indietro</button>
        </div>
    </div>
</div>
<!-- /#page-wrapper -->
