                                ...
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody>
                                        <tr itemscope itemtype="http://schema.org/Person">
                                            <td>Kimbo</td>
                                            <td itemprop="givenName"><?= $faker->firstName ?></td>
                                            <td itemprop="familyName"><?= $faker->lastName ?></td>
                                            <td itemprop="email"><?= $faker->email ?></td>
                                            <td itemprop="telephone"><?= $faker->PhoneNumber ?></td>
